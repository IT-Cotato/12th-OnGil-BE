...
public class AiMaterialService {
	...
	private String createPrompt(String material) {
		return String.format("""
			...
			[단점 작성 규칙]
			- 단점에는 세탁, 빨래, 물, 건조, 말림, 다림질 등 관리 관련 내용 절대 작성 금지
			- 단점은 반드시 착용감, 촉감, 무게, 내구성, 시간경과 변화만 작성
			- 단, 시간 경과로 자연스럽게 발생하는 변화는 작성 가능 (예: 오래 입으면 늘어나요)
			- 세탁 때문에 발생하는 변화는 절대 단점에 작성 금지
			- 세탁과 관리 관련 내용은 오직 [세탁방법]에만 작성
			- 이 규칙을 어기면 다시 작성
			""", material);
	}
